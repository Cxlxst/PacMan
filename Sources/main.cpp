  ...
  while(device->run())
    {
	  ...
	  if(check_menu >= 1 && check_menu <= 8)
	    {
	      guienv->clear();
	      device->getGUIEnvironment()->addImage(driver->getTexture("Menu_1.jpg"), position2d<s32>(0,0));
	  ...
	  if(check_menu >= 9 && check_menu <=16)
	    {
	      guienv->clear();
	      device->getGUIEnvironment()->addImage(driver->getTexture("Menu_2.jpg"), position2d<s32>(0,0));
	  ...
	  if(check_menu >= 17 && check_menu <= 24)
	    {
	      guienv->clear();
	      device->getGUIEnvironment()->addImage(driver->getTexture("Menu_3.jpg"), position2d<s32>(0,0));
	...
	{
	  guienv->clear();
	  device->getGUIEnvironment()->addImage(driver->getTexture("texture_map.jpg"), position2d<s32>(0,0));
	}
